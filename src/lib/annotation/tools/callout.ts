import type { Annotation, AnnotationState, CalloutAnnotation, Tool } from "./types.ts";
...
export const calloutTool: Tool = {
  ...
  render(ctx: CanvasRenderingContext2D, annotation: Annotation) {
    const a = annotation as CalloutAnnotation;
    ...
    // Label box (to the right of the circle)
    if (a.label) {
